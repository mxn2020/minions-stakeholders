...
/**
 * @minions-stakeholders/cli — CLI for Minions Stakeholders
 *
...
import { customTypes } from '@minions-stakeholders/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Stakeholders'));
        console.log(chalk.dim('Stakeholder registry, roles, and communication preferences'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-stakeholders/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-stakeholders/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-stakeholders')}`);
