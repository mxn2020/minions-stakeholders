# Manual Setup Steps for Minions Stakeholders
...
Go to **GitHub → mxn2020/minions-stakeholders → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-stakeholders` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-stakeholders-web`
- **GitHub repo**: `mxn2020/minions-stakeholders`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `stakeholders.minions.wtf`

### Documentation
- **Netlify site name**: `minions-stakeholders-docs`
- **GitHub repo**: `mxn2020/minions-stakeholders`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `stakeholders.minions.help`

### Blog
- **Netlify site name**: `minions-stakeholders-blog`
- **GitHub repo**: `mxn2020/minions-stakeholders`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `stakeholders.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `stakeholders.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `stakeholders.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `stakeholders.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-stakeholders/sdk`](https://www.npmjs.com/package/@minions-stakeholders/sdk)
- CLI: [`@minions-stakeholders/cli`](https://www.npmjs.com/package/@minions-stakeholders/cli)
...
Your package: [`minions-stakeholders`](https://pypi.org/project/minions-stakeholders/)
...
| Item | Value |
|------|-------|
| Project | `minions-stakeholders` |
| SDK (npm) | `@minions-stakeholders/sdk` |
| CLI (npm) | `@minions-stakeholders/cli` |
| Python (PyPI) | `minions-stakeholders` |
| GitHub | `github.com/mxn2020/minions-stakeholders` |
| Docs domain | `stakeholders.minions.help` |
| Blog domain | `stakeholders.minions.blog` |
| App domain | `stakeholders.minions.wtf` |
