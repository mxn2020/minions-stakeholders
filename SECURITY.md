...
- `@minions-stakeholders/sdk` (npm package)
- `minions-stakeholders` (PyPI package)
- `@minions-stakeholders/cli` (npm package)
- The minions-stakeholders web playground
- The minions-stakeholders documentation site
